...
class MeasureVAE(Model):
    ...
    def __repr__(self):
        ...
        """
        return self.dataset_type + '_MeasureVAE' + self.trainer_config

    def forward(self, measure_score_tensor: torch.Tensor,
                measure_metadata_tensor: torch.Tensor, train=True):
        """
        Implements the forward pass of the VAE
        :param measure_score_tensor: torch Tensor,
                (batch_size, measure_seq_length)
        :param measure_metadata_tensor: torch Tensor,
    ...
    def forward_test(self, measure_score_tensor: torch.Tensor):
        """
        Implements the forward pass of the VAE
        :param measure_score_tensor: torch Tensor,
